...
2. Ecrire une classe `Fifo` dans le package m1.tp.structurededonnees.queue prenant en paramètre le nombre maximal d'élements que peut stocker la structure de données. Penser à vérifier les préconditions.
